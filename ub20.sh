...
clear;clear;clear
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo -e "\033[92;1m              WELCOME TO SILAVPN-SCRIPT              \033[0m"
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo ""
sleep 3
...
clear
rm -f /usr/bin/user
username=$(curl https://raw.githubusercontent.com/UnderTunnel/ip/main/ip | grep $MYIP | awk '{print $2}')
echo "$username" >/usr/bin/user
expx=$(curl https://raw.githubusercontent.com/UnderTunnel/ip/main/ip | grep $MYIP | awk '{print $3}')
echo "$expx" >/usr/bin/e
...
Exp1=$(curl https://raw.githubusercontent.com/UnderTunnel/ip/main/ip | grep $MYIP | awk '{print $4}')
if [[ $today < $Exp1 ]]; then
sts="${Info}"
else
sts="${Error}"
...
echo -e "\e[32mloading...\e[0m"
clear
REPO="https://raw.githubusercontent.com/UnderTunnel/script/main/"
start=$(date +%s)
secs_to_human() {
...
clear
restart_system() {
USRSC=$(wget -qO- https://raw.githubusercontent.com/UnderTunnel/izin/main/ip | grep $ipsaya | awk '{print $2}')
EXPSC=$(wget -qO- https://raw.githubusercontent.com/UnderTunnel/izin/main/ip | grep $ipsaya | awk '{print $3}')
...
"'&reply_markup={"inline_keyboard":[[{"text":"ORDER","url":"https://t.me/SilaaVp"},{"text":"WA","url":"https://wa.me/6281249681707"}]]}'
...
wget https://raw.githubusercontent.com/UnderTunnel/script/main/menuku.zip
wget -q -O /usr/bin/enc "https://raw.githubusercontent.com/UnderTunnel/script/main/Enc/encrypt" ; chmod +x /usr/bin/enc
7z x -pBumiAyuVpn12BAV menuku.zip
chmod +x menu/*
enc menu/*
...
wget https://raw.githubusercontent.com/UnderTunnel/script/main/Cfg/m-noobz 
